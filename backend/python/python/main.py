...
#  Fichier : main.py
#  Description : Interface graphique avancée pour la surveillance et la défense
#                contre les attaques DDoS, avec analyse de trafic, alertes,
#                gestion de pare-feu, notifications, et visualisation temps réel.
#  Auteur : [Votre nom]
#  Version : Voir variable VERSION
#  --------------------------------------------------------------------------
#  Ce fichier est massivement commenté pour la pédagogie et la présentation.
#  Chaque section, fonction et choix technique est expliqué.
...
class AdvancedAntiDDoSGUI:
    ...
    def create_blocked_ips_panel(self):
        ...
        # Ce panneau affiche la liste des adresses IP actuellement bloquées par le pare-feu.
        blocked_frame = ttk.LabelFrame(self.left_panel, text="IPs bloquées")
        blocked_frame.pack(fill=tk.BOTH, expand=True, padx=5, pady=5)

        # Liste des IPs bloquées (tableau avec colonnes IP, date, raison)
        ...
        # Boutons pour débloquer une IP ou toutes les IPs
    ...
    def create_analysis_panel(self):
        ...
        # Ce panneau contient les graphiques d'analyse du trafic réseau.
    ...
    def setup_graphs(self):
        ...
        # Préparation du graphique en temps réel (matplotlib)
        ...
        # Application du style graphique
        ...
        # Graphique des statistiques (2 sous-graphiques)
        ...
        # Configuration des axes statistiques
        ...
        # Graphique des patterns détectés
    ...
    def start_updates(self):
        ...
        # Cette méthode lance la boucle de mise à jour de l'interface (trafic, graphes...)
        self.update_gui()
        self.update_graphs()
    ...
    def update_gui(self):
        ...
        if self.is_monitoring:
            ...
            # Ajout à l'historique pour les graphiques
            ...
            # Si anomalie détectée, gestion de l'alerte
            if is_anomaly:
    ...
    def update_realtime_graph(self):
        ...
        # Préparation des données (100 derniers points)
        ...
        # Tracé du graphique (ligne + points colorés selon menace)
    ...
    def update_stats_graphs(self):
        ...
        # Histogramme de la distribution du trafic
        ...
        # Courbe des tendances (évolution du trafic)
    ...
    def update_patterns_graph(self):
        ...
        # Détection des patterns (pics, tendances...)
    ...
    def get_color_for_threat(self, threat_level):
        ...
        # Cette fonction permet d'afficher les points du graphique en couleur selon le niveau de menace.
        colors = {
            'critical': 'red',
            'warning': 'orange',
            'notice': 'yellow',
    ...
    def start_monitoring(self):
        ...
        # Active la surveillance, met à jour l'état de l'interface et envoie une notification.
    ...
    def stop_monitoring(self):
        ...
        # Désactive la surveillance, sauvegarde les données et envoie une notification.
        self.is_monitoring = False
        self.status_var.set("État: Arrêté")
        self.start_button.configure(state=tk.NORMAL)
        self.stop_button.configure(state=tk.DISABLED)

        # Sauvegarde des données de surveillance
    ...
    def handle_anomaly(self, traffic, score, threat_level):
        ...
        # Cette méthode est appelée lorsqu'une anomalie est détectée dans le trafic.
        # Elle enregistre l'alerte, envoie une notification et peut bloquer automatiquement des IPs.
        message = f"""
        Anomalie détectée !
        ------------------
        ...
        # Blocage automatique si activé et menace critique
    ...
    def update_blocked_ips_list(self):
        ...
        # Rafraîchit l'affichage de la liste des IPs bloquées dans l'interface.
    ...
    def unblock_selected_ip(self):
        ...
        # Permet à l'utilisateur de débloquer une IP sélectionnée dans la liste.
    ...
    def unblock_all_ips(self):
        ...
        # Permet de débloquer toutes les IPs bloquées d'un coup (confirmation demandée).
    ...
    def save_monitoring_data(self):
        ...
        # Sauvegarde l'historique du trafic et des alertes dans un fichier JSON pour analyse ultérieure.
        if not self.traffic_history:
            return
    ...
    def show_config_dialog(self):
        ...
        # Ouvre une fenêtre pour modifier les seuils, notifications et options du pare-feu.
        ...
        # Onglet des seuils (critique, warning)
        ...
        # Onglet des notifications (email, Telegram)
        ...
        # Onglet du pare-feu (blocage auto, durée)
    ...
    def test_notifications(self):
        ...
        # Permet de tester l'envoi de notifications (email, Telegram...) pour vérifier la configuration.
    ...
    def run(self):
        """Lance l'application."""
        # Boucle principale Tkinter (affichage de la fenêtre)
